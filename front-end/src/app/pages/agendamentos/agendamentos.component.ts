...
export class AgendamentosComponent {
  ...
  visible = false;
  dialogType: 'newAgendamento' | 'edit' = 'newAgendamento';
  newAgendamento: any = {};
  ...
  showDialog(type: 'newAgendamento' | 'edit', agendamento?: Agendamento) {
    this.dialogType = type;
    this.visible = true;

    if (type === 'edit' && agendamento) {
      this.newAgendamento = { ...agendamento };
    } else {
      this.newAgendamento = {
        date: new Date(),
        time: '',
